    ...
    const logged_in =
                <div className="w-full block flex-no-shrink lg:w-auto">
                  ...
                  <div>
                    ...
                    <Link to='/' onClick={this.handleLogout} className="inline-block text-base px-4 py-2 leading-none mt-4 lg:inline-block lg:mt-0 text-teal-lighter hover:text-white mr-4">Logout</Link>
