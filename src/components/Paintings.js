...
class Paintings extends Component{
  ...
  // debugger;
  return (
    <div className="flex justify-center bg-grey-lighter h-full px-8">
      <div className="items-start bg-grey-lighter bg-white shadow-md w-screen rounded px-8 mt-8 mb-8 py-8 h-auto">
        <div className="flex">
          ...
          <div className="flex-1 text-grey-darker text-center bg-grey-light px-4 py-2 m-2"><label className="shadow bg-purple text-white font-bold py-2 px-4 items-center rounded text-xl" >Everyones Paintings</label></div>
